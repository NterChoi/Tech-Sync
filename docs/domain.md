...
| DRAFT_SNAPSHOT  | 30초 자동저장 (단일 문서 upsert) | ROOM_ID(PK), CONTENT, LAST_EDITOR_ID |
| DRAFT_VERSION   | 수동 저장 체크포인트 | VERSION_ID, ROOM_ID, VERSION_NO, VERSION_TYPE(MAJOR/MINOR) |
| DELTA_LOG       | OT 충돌 해결의 핵심 — 편집 최소 단위 | ROOM_ID, OP_TYPE, POSITION, CONTENT, SEQ_NO |
